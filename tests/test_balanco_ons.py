...
class StreamlitReloadCompatibilityTests(unittest.TestCase):
    def test_module_loads_without_pre_registration_in_sys_modules(self) -> None:
        module_path = Path(__file__).resolve().parents[1] / "balanco_ons.py"
        module_name = "balanco_ons_streamlit_reload_probe"
        ...
        self.assertTrue(hasattr(module, "ProcessingResult"))
        self.assertTrue(hasattr(module, "download_ons_year"))
